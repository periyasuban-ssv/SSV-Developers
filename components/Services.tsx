...
const Services: React.FC = () => {
  ...
  return (
    <section
      id="services"
      className="py-20 bg-slate-900 text-white relative scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-amber-500 font-bold tracking-wider uppercase text-sm mb-3">
            Our Expertise
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            <div
              key={service.id}
              className="group p-8 bg-slate-800 rounded-2xl hover:bg-slate-700 transition-all duration-300 border border-slate-700 hover:border-amber-500 transform hover:-translate-y-2 cursor-default hover:shadow-2xl hover:shadow-amber-500/10"
            >
              ...
              <h4 className="text-xl font-bold mb-3 group-hover:text-amber-400 transition-colors">
                {service.title}
              </h4>
